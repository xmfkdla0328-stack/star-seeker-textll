...
export const ONBOARDING_STEPS = {
  ...
  [ONBOARDING_STEP_IDS.FACILITY_GUIDE]: {
    ...
    scripts: [
      ...
      '‘생존권을 위협받고 있는 인류’를 찾아내고 그들의 위치 좌표를 특정하기 위한 ‘관측’ 기능을 수행하는 구체 형태의 방인 흘리드스키알프, 특정된 좌표로 정신체를 쏘아보내는 ‘투사’ 기능을 수행하는 통로인 프시코폼포스, 주변 환경에 존재하는 재료를 활용하여 사물을 빚어내는 ‘구축’ 기능을 수행하는 정팔면체 형태의 도구인 케러 안시크 등이 바로 그 예시입니다.',
    ],
